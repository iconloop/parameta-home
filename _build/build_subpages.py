...
.post-body p{ font-size:var(--text-body); line-height:var(--lh-body); color:var(--c-body) }
...
.post-side a.is-active{ color:var(--accent); border-color:var(--accent); font-weight:var(--w-title) }   /* 현재 보고 있는 섹션 */
...
body.blog .phero-h1{ font-size:var(--text-28); max-width:28ch }
@media (min-width:640px){ body.blog .phero-h1{ font-size:var(--text-32) } }
@media (min-width:768px){ body.blog .phero-h1{ font-size:var(--text-40) } }
@media (min-width:1024px){ body.blog .phero-h1{ font-size:var(--text-48) } }

  ...
  if (!mega){
    ...
    <div class="mega-inner">\
      ...
      <div class="mega-panel" data-for="products"><div class="nav-drop-panel">\
        ...
        <a href="myid.html"><span class="nd-ico"><svg class="icn" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-6 8-6s8 2 8 6"/></svg></span><span class="nd-txt"><b>MyID</b><span>DID 신원인증 · K-BTF 공공 SaaS</span></span></a>\

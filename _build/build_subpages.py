...
@media (min-width:768px) and (max-width:1023px){ :root{
  ...
  --space-32:1.5rem;   /* 카드류 패딩 한 단계 다운 (32→24 값) */
} }
...
.recog-chips{ margin-top:clamp(var(--space-24), 5.2vw, var(--space-80)) }   /* 위 간격: 화면 폭 가변 (768≈40, 1440≈75, 상한 80) */
...
.aw-item b{ font-size:var(--text-18); font-weight:500; color:var(--ink); line-height:1.35; word-break:keep-all }   /* 14→16→18 */
.aw-item figcaption span{ font-size:var(--text-16); color:var(--muted) }   /* 12→14→16 */
...
.fh-list li{ display:flex; align-items:center; gap:.9rem; padding-block:1rem;
  font-size:var(--text-20); font-weight:500; color:var(--ink); line-height:1.4 }   /* 두 토큰 업(16→20) */
...
.fh-sub{ margin-left:auto; padding-left:1rem; font-size:var(--text-18); font-weight:400; color:rgba(var(--ink-rgb),.6); white-space:nowrap }   /* 두 토큰 업(14→18) */
@media (max-width:767px){
...
@media (min-width:900px){ .ht2 .ht2-body{ grid-column:6 / 13 } }
...
.ht2-group{ background:rgba(var(--ink-rgb),.04); border-radius:var(--radius-card);
  padding:var(--space-16) var(--space-32) }   /* 시대별 그레이 카드로 묶음 */
...
.ht2-era-head .ht2-t{ font-size:var(--text-26); font-weight:700; line-height:var(--leading-heading); margin-top:var(--space-8) }
.ht2-yrin{ flex:none; min-width:4.5rem; font-size:var(--text-24); font-weight:700; font-variant-numeric:tabular-nums }   /* 22→24 */
.ht2-acc summary > span{ flex:1 }
.ht2-acc summary{ display:flex; justify-content:space-between; align-items:center; gap:var(--space-16);
  font-size:var(--text-20); font-weight:600; color:var(--ink); padding:var(--space-20) 0; cursor:pointer;
  list-style:none; border-top:1px solid rgba(var(--ink-rgb),.09) }   /* 폰트 18→20, 여백 12→20 */
.ht2-acc:first-of-type summary{ border-top:0 }
.ht2-acc summary::-webkit-details-marker{ display:none }
.ht2-chev{ flex:none; width:.625rem; height:.625rem; margin-top:-.25rem;
  border-right:2px solid rgba(var(--ink-rgb),.45); border-bottom:2px solid rgba(var(--ink-rgb),.45);
  transform:rotate(45deg); transition:transform .45s cubic-bezier(.16,1,.3,1), border-color .2s }   /* 기존 ht-chev 컨벤션 */
.ht2-acc[open] .ht2-chev{ transform:rotate(225deg); margin-top:.25rem; border-color:var(--purple-500) }
@media (hover:hover){
  .ht2-acc summary{ transition:color .2s }
  .ht2-acc summary:hover{ color:var(--purple-500) }
  .ht2-acc summary:hover .ht2-chev{ border-color:var(--purple-500) }
}
.ht2-rows{ list-style:none; margin:0; padding:0 0 var(--space-16) }
.ht2-rows li{ display:flex; gap:var(--space-12); border-top:1px solid rgba(var(--ink-rgb),.06);
  padding:var(--space-12) 0; font-size:var(--text-16); font-weight:500; color:var(--ink); line-height:var(--leading-body) }
.ht2-rows li .m{ flex:none; min-width:2.75rem; color:rgba(var(--ink-rgb),.4); font-weight:400; font-variant-numeric:tabular-nums }
@media (max-width:899px){
  .ht2 .cm-head{ display:none }
  .ht2-era-head{ display:block; margin-bottom:var(--space-16) }
}
/* Alliance 소절 카드 위 여백 */
...
.firsts-eco .eco-pill i{ font-style:normal; color:rgba(var(--ink-rgb),.55); margin-left:.375rem }
@media (max-width:767px){
...
.firsts-eco{ margin-top:clamp(var(--space-24), 5.2vw, var(--space-80)) }   /* 인증수상(recog-chips)과 동일 가변 커브 */
...
body.press .phero{ min-height:60vh; display:flex; flex-direction:column; justify-content:center }  /* 화면 3/5 */
...
body.press .phero-h1{ max-width:none; font-size:var(--text-32);
  line-height:var(--leading-heading) }  /* 긴 뉴스 제목 — display(.98) 대신 heading(1.25) 토큰 */
...
.psm-panel h2{ text-align:center; font-size:var(--text-22); font-weight:600; margin-bottom:1.75rem }
...
.pd-fig figcaption{ margin-top:.75rem; font-size:var(--text-16); color:var(--muted);
  text-align:center; line-height:var(--leading-body); word-break:keep-all }
.pd-body > p{ font-size:var(--text-20); line-height:var(--leading-body); color:rgba(var(--ink-rgb),.75);
...
<div class="cm-grid">
  <div class="cm-head">
    <div class="cm-sticky">
      <div class="cm-head-in rvl" style="--rvl-y:20px">
        ...
        <div class="ht2-fade">
          <div class="ht2-layer on"><h2 class="sec-h2" style="max-width:14ch">2023 — 2026<br>디지털자산 인프라 확장</h2></div>
          <div class="ht2-layer"><h2 class="sec-h2" style="max-width:14ch">2019 — 2022<br>DID 상용화와 공공 확산, Web2 → Web3 전환 확대</h2></div>
          <div class="ht2-layer"><h2 class="sec-h2" style="max-width:14ch">2016 — 2018<br>기술 기반 구축</h2></div>
        </div>
      </div>
    </div>
  </div>
  <div class="ht2-body">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2026</b><span>APAC 확장 — ADB 채권 포럼 국경 간 거래 표준모델 발표 등 시장 확대</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2025</b><span>Stablecoin Alliance 초대 의장사 선임</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2024</b><span>K-BTF 공공 블록체인 공동인프라 사업자 선정</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2023</b><span>PARAMETA 리브랜딩, 디지털자산 인프라 기업 전환</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <div class="ht2-group rvl" style="--rvl-y:24px" data-rng="2019 — 2022" data-title="DID 상용화와 공공 확산, Web2 → Web3 전환 확대">
      <div class="ht2-era-head"><h3 class="ht2-t">2019 — 2022<br>DID 상용화와 공공 확산, Web2 → Web3 전환 확대</h3></div>

    <details class="ht2-acc"><summary><b class="ht2-yrin">2022</b><span>블록체인 프레임워크 'Parameta Framework' 공개</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2021</b><span>NH농협은행 DID 실명인증 출시, 금융·기업·공공으로 적용 확산</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2020</b><span>신한은행 국내 최초 금융권 DID 실명인증 상용화</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2019</b><span>분산ID 'MyID' 혁신금융서비스 지정</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2018</b><span>라인과 블록체인 합작법인 설립</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2017</b><span>세계 최초 블록체인 공동인증 'CHAIN ID' 상용화</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
    ...
    <details class="ht2-acc"><summary><b class="ht2-yrin">2016</b><span>(주)더루프 설립, 국내 1세대 Web3 인프라 기업 출발</span><span class="ht2-chev" aria-hidden="true"></span></summary><ul class="ht2-rows">
...
</div><script>/* History: 아코디언 하나만 열림 + 스크롤 시 좌측 시대 페이드 전환 */
document.querySelectorAll('.ht2-acc').forEach(function(d){
  d.addEventListener('toggle', function(){
    if (d.open) document.querySelectorAll('.ht2-acc[open]').forEach(function(o){ if (o !== d) o.open = false; });
  });
});
(function(){
  ...
  if(groups[0]) groups[0].classList.add('ht2-on');
...
<section><div class="shell sec">
  ...
  {ww_compare('발행 이후의 운영을 각자 감당해야 합니다', '발행부터 운영까지 하나로 연결합니다', [
    ...
    ('계좌와 온체인 시스템의 분절', '은행 계좌와 온체인 지갑이 분리되어 있어 자산 관리와 정산이 복잡합니다.',
...
<section><div class="shell sec">
  ...
  {cards_wrap([
    ...
    exchange_card('Orchestration · 오케스트레이션', brand='var(--purple-500)', desc='은행 계좌와 온체인 지갑을 연결해 조건부 정산과 실시간 거래 스크리닝을 지원합니다.'),
...
<section><div class="shell sec">
  {sec_head('Platform', '기본 제공 기능', '사용자는 필요한 정보만 선택 공개(Selective Disclosure)로 제출할 수 있으며, 개인 데이터는 사용자 단말과 분산 환경에 저장해 기관의 보관 부담을 줄입니다. 이를 바탕으로 발급·보유·검증으로 이어지는 표준화된 신원 흐름을 구현합니다.')}
  {cards_wrap([
  ...
  <div class="uc-carousel uc-tall uc-lg">
    ...
    <div class="uc-slides rvl" style="--rvl-y:40px">
      <article class="uc-slide is-active">
        ...
        <div class="uc-rows"><div class="uc-row"><span class="uc-flag">과제</span><span>배터리 제조·운행·정비·사용후 데이터가 흩어져 있고, EU DPP 규정에 맞춰 신뢰할 수 있게 연결·검증해야 합니다.</span></div><div class="uc-row"><span class="uc-flag">해결</span><span>K-BTF(Korea Blockchain Trust Framework) 기반 DID·데이터 인프라로 각 단계 데이터를 연결하고 발급·검증 흐름을 표준화했습니다.</span></div></div>
      </article>
      <article class="uc-slide">
        <div class="uc-thumb" aria-hidden="true"></div>
      ...
      <article class="uc-slide">
        <div class="uc-thumb" aria-hidden="true"></div>
        <h3>제주도 · 제주안심코드</h3>
        <div class="uc-rows"><div class="uc-row"><span class="uc-flag">과제</span><span>대규모 방문 인증을 빠르게 처리하면서 개인정보 노출을 줄여야 합니다.</span></div><div class="uc-row"><span class="uc-flag">해결</span><span>QR 기반 인증으로 6만 업장·218만 이용자·누적 9,100만 건 인증을 운영했습니다.</span></div></div>
      </article>
    </div>
    <button class="uc-arrow uc-next rvl rvl-op" type="button" aria-label="다음 사례"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 5l7 7-7 7"/></svg></button>
  </div>
...
PAGES['solution-cert.html'] = dict(
    ...
    content=f"""
<section><div class="shell sec sec-top-lg sec-stagger">
  {sec_head('Why Now', '증명서는 발급보다 발급 이후가 더 부담입니다', 'PDF나 이미지 증명서는 제출처가 원본 여부를 확인하기 어렵고, 발급기관은 발급 이후에도 검증 문의, 재발급, 서버, 보안 운영을 계속 감당해야 합니다. 증명 하나를 위해 검증 시스템을 따로 만들어 유지하는 구조입니다.<br>한편 증명서 디지털화는 이미 흐름이 됐습니다. 정부 전자문서지갑에는 481종의 전자증명서가 올라가 있고, 정부24 회원 약 2천만 명, 연계 앱 59개가 있습니다.')}
...
<section><div class="shell sec">
  ...
  {compare_table(['', 'broof형 — 웹 발급 서비스', 'MyID형 — 신원 기반 자격증명'], [
    dict(label='구조', cells=['웹에서 바로 연동 발급 서비스(SaaS)', 'DID 기반 자격증명 인프라']),
...
<section><div class="shell sec" style="padding-top:0">
  {sec_head('FAQ', '자주 묻는 질문')}
  {faq([
    dict(q='QR코드·검증 링크로 어떻게 확인하나요?', a='발급된 증명에 붙은 QR코드나 검증 링크로 발급기관에 문의하지 않아도 제출처가 원본 여부를 바로 확인합니다.'),
    dict(q='발급기관은 검증 시스템을 따로 만들어야 하나요?', a='아니요. broof형은 웹 서비스로, MyID형은 신원·자격증명 인프라 연결로 발급·검증 흐름을 제공하므로 기관이 별도 검증 시스템을 구축·운영하지 않습니다.'),
  ...
  <div class="uc-carousel uc-tall uc-lg">
    ...
    <div class="uc-slides rvl" style="--rvl-y:40px">
      ...
      <article class="uc-slide">
        ...
        <div class="uc-rows"><div class="uc-row"><span class="uc-flag">형태</span><span>broof형</span></div><div class="uc-row"><span class="uc-flag">과제</span><span>수료, 이수 증명을 받은 제출처가 진짜인지 발급기관에 다시 문의해야 했습니다.</span></div><div class="uc-row"><span class="uc-flag">해결</span><span>발급한 증명에 QR코드와 검증 링크를 붙여, 제출처가 문의 없이 원본과 위·변조 여부를 바로 확인하도록 했습니다.</span></div><div class="uc-row"><span class="uc-flag">결과</span><span>발급기관이 검증 문의에 일일이 대응하지 않아도 됩니다.</span></div></div>
      </article>
      <article class="uc-slide">
        <div class="uc-thumb" aria-hidden="true"></div>
        <h3>금융권 실명확인</h3>
        <div class="uc-rows"><div class="uc-row"><span class="uc-flag">형태</span><span>MyID형</span></div><div class="uc-row"><span class="uc-flag">과제</span><span>금융 서비스마다 실명확인을 처음부터 다시 해서, 사용자는 같은 서류를 반복 제출하고 기관은 개인정보를 반복 보관했습니다.</span></div><div class="uc-row"><span class="uc-flag">해결</span><span>한 번 확인한 신원을 사용자가 직접 관리하는 신원(DID)으로 보관하고, 다른 서비스에서도 필요한 정보만 골라 제출하도록 했습니다.</span></div><div class="uc-row"><span class="uc-flag">결과</span><span>국내 최초로 금융권 DID 실명확인을 상용화했습니다.</span></div></div>
      </article>
      <article class="uc-slide">
        <div class="uc-thumb" aria-hidden="true"></div>
        <h3>공공 대규모 인증 (제주안심코드)</h3>
        <div class="uc-rows"><div class="uc-row"><span class="uc-flag">형태</span><span>MyID형</span></div><div class="uc-row"><span class="uc-flag">과제</span><span>감염병 확산기의 대규모 방문 인증을, 개인정보 부담을 최소화하면서 빠르게 처리해야 했습니다.</span></div><div class="uc-row"><span class="uc-flag">해결</span><span>개인정보를 최소한만 남기는 방식으로 방문 인증을 제공했습니다.</span></div><div class="uc-row"><span class="uc-flag">결과</span><span>누적 9,100만 건 인증을 운영했습니다.</span></div></div>
      </article>
    </div>
    <button class="uc-arrow uc-next rvl rvl-op" type="button" aria-label="다음 사례"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 5l7 7-7 7"/></svg></button>
  </div>
...
<section><div class="shell sec">
  ...
  {cards_wrap([
    exchange_card('거래소 연동', gray=True, desc='외부 CEX·DEX 유동성을 자사 서비스에 연결합니다.'),
    exchange_card('Smart Access · QR', gray=True, desc='API 키 입력 없이 QR 한 번으로 거래소를 연결합니다.'),
    exchange_card('Pro-Level Interface · 전문 거래 화면', gray=True, desc='트레이더용 전문 대시보드와 TradingView를 기본 제공하고, 여러 거래소 포트폴리오를 한눈에 관리합니다.'),
    exchange_card('Performance Analytics · 성과 분석', gray=True, desc='여러 거래소의 성과를 한 대시보드에서 보고, 손익(PnL)을 정밀하게 분석합니다.'),
    exchange_card('Non-Custodial Security · 비수탁 보안', gray=True, desc='서버에 민감 정보를 저장하지 않는 비수탁 방식으로 자산을 안전하게 지킵니다.'),
  ], cols=3)}
</div></section>
<!-- By the Numbers: 다크 스탯 패널 -->
<section><div class="shell stats-shell">
  ...
  <div class="uc-carousel uc-tall uc-lg">
    ...
    <div class="uc-slides rvl" style="--rvl-y:40px">
      <article class="uc-slide is-active">
        <div class="uc-thumb" aria-hidden="true"></div>
        <h3>Supercycl</h3>
        <div class="uc-rows"><div class="uc-row"><span class="uc-flag">과제</span><span>자사 서비스 안에 거래 기능을 빠르게 붙여 시장 반응을 확인해야 합니다.</span></div><div class="uc-row"><span class="uc-flag">해결</span><span>PortX의 거래소 연동과 QR 연결(Smart Access)에 전문 거래 화면, 손익(PnL) 분석까지 더해, 짧은 기간에 자사 브랜드 거래 서비스를 구축하고 초기 사용자를 확보했습니다.</span></div></div>
      </article>
      <article class="uc-slide">
        <div class="uc-thumb" aria-hidden="true"></div>
...
<section><div class="shell sec">
  ...
  {ww_compare('개인정보를 직접 떠안아야 합니다', '개인정보를 떠안지 않는 구조로 바꿉니다', [
    ...
    ('사용자 통제 요구', '전송요구권 등 사용자가 자기 데이터를 옮기거나 지워 달라는 요구에 대응해야 합니다.',
     '필요한 것만 골라 제출', '사용자가 필요한 항목만 골라 제출하고, 옮기거나 지워 달라는 요구도 바로 처리됩니다.'),
...
<section><div class="shell sec">
  ...
  {ww_compare('정산마다 수작업 대사가 반복됩니다', '복잡한 정산을 한 번에 처리합니다', [
    ...
    ('다자 분배와 정산', '여러 파트너가 얽힌 분배와 정산은 대사와 통제가 복잡합니다.',
     '규칙대로 자동 분배', '여러 파트너의 몫이 정해진 규칙대로 자동 분배, 정산됩니다.'),
...
<section><div class="shell sec">
  ...
  {cards_wrap([
    ...
    exchange_card('Dual-Rail 도입', gray=True, desc='기존 결제 레일을 유지하면서 토큰 정산 레일을 병행해, 도입 부담을 낮춥니다.'),

...
body.company .tr-flush .work-meta{ color:var(--purple-500); font-weight:600; margin-bottom:var(--space-16) }   /* 라벨 3개 보라색 */
body.company .tr-flush .work-card h3{ font-size:var(--text-36); font-weight:700; letter-spacing:-.01em; color:var(--ink) }
body.company .tr-flush .work-bottom p{ margin-top:.5rem; font-size:var(--text-18); color:rgba(var(--ink-rgb),.6) }
...
<section class="tr-flush"><div class="shell sec">
  ...
  <ul class="cards-3"><li class="rvl" style="--rvl-delay:0ms"><article class="work-card static grouped t-gray"><div class="work-bottom"><div class="work-meta"><span>Since 2016</span></div><h3>10 Years</h3><p>국내 1세대 Web3 인프라 기업</p></div></article></li><li class="rvl" style="--rvl-delay:90ms"><article class="work-card static grouped t-gray"><div class="work-bottom"><div class="work-meta"><span>Investment</span></div><h3>250억 원</h3><p>누적 투자유치</p></div></article></li><li class="rvl" style="--rvl-delay:180ms"><article class="work-card static grouped t-gray"><div class="work-bottom"><div class="work-meta"><span>Revenue</span></div><h3>750억 원+</h3><p>누적 매출 (2016~2025)</p></div></article></li></ul>

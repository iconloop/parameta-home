...
.sub-t{ display:block; font-size:var(--text-22); font-weight:700; color:var(--ink); line-height:1 }
/* ============ SUBPAGE HERO ============ */
...
@media (max-width:767px){
  body.company .tr-flush .cards-3{ grid-template-columns:repeat(3,1fr); gap:0;
    background-color:rgba(var(--ink-rgb),.04); border-radius:var(--radius-card-sm); padding:var(--space-24) 0;
  ...
  body.company .tr-flush .work-meta{ margin-bottom:var(--space-8); justify-content:center }  /* Since 2016 센터 (기본 flex space-between 해제) */
  body.company .tr-flush .work-card h3{ font-size:var(--text-22) }   /* 640~767: 한 토큰 다운(24→22) */
  body.company .tr-flush .work-bottom p{ font-size:var(--text-14) }
}
@media (max-width:639px){
  body.company .tr-flush .work-card h3{ font-size:var(--text-20); white-space:nowrap }   /* 수치 두 토큰 다운 + 줄바꿈 금지 */
  body.company .tr-flush .work-bottom{ padding:0 var(--space-8) }   /* 좁은 칸: 안쪽 패딩 축소 */
...
@media (max-width:1023px){
  .sec-lead, .sh-center .sec-lead{ margin-bottom:2rem }
  .sec-h2:not(.has-lead){ margin-bottom:2rem }
}
...
.ally-marquee-wrap{ display:grid; grid-template-columns:auto minmax(0,1fr); align-items:center; gap:2rem;
  margin-top:3.5rem }
...
@media (max-width:639px){ .ally-marquee-wrap{ grid-template-columns:1fr; gap:1.25rem } }
...
.recog-chips{ margin-top:var(--space-80) }   /* 디바이더 삭제, 위 간격 48→80 */
@media (min-width:768px) and (max-width:1023px){ .recog-chips{ margin-top:var(--space-48) } }   /* 태블릿: 카드↔인증수상 간격 축소 */
.recog-chips .rc-label{ margin-bottom:var(--space-40) }   /* 스타일은 .sub-t 공통 토큰, 로고와 간격 24→40 */
@media (min-width:768px) and (max-width:1023px){ .recog-chips .rc-label{ margin-bottom:var(--space-32) } }   /* 태블릿: 타이틀↔아이콘 간격 축소 */
...
.aw-item{ display:flex; flex-direction:column; align-items:center; gap:1.25rem;
    ...
    <div class="aw-marquee rvl" style="--rvl-y:40px; --rvl-delay:150ms" aria-label="인증 수상 목록">
      <div class="pt-track">
        <div class="aw-set">
          ...
          <figure class="aw-item"><span class="aw-logo"><img src="assets/awards/logo-tcb.png" alt="" onerror="this.style.display='none'"><i>TI-1</i></span><figcaption><b>기술평가 TI-1</b><span>최고 등급</span></figcaption></figure>
          <figure class="aw-item"><span class="aw-logo"><img src="assets/awards/logo-csap.png" alt="" onerror="this.style.display='none'"><i>CSAP</i></span><figcaption><b>CSAP 인증</b><span>블록체인 최초</span></figcaption></figure>
          <figure class="aw-item"><span class="aw-logo"><img src="assets/awards/logo-msit.png" alt="" onerror="this.style.display='none'"><i>MSIT</i></span><figcaption><b>과기정통부 장관 표창</b><span>과학기술정보통신부 2018</span></figcaption></figure>
          <figure class="aw-item"><span class="aw-logo"><img src="assets/awards/logo-kisa.png" alt="" onerror="this.style.display='none'"><i>KISA</i></span><figcaption><b>기술특례상장 A등급</b><span>KISA 2년 연속</span></figcaption></figure>
          ...
          <figure class="aw-item"><span class="aw-logo"><img src="assets/awards/logo-swaward.png" alt="" onerror="this.style.display='none'"><i>SW</i></span><figcaption><b>SW품질대상 최우수상</b><span>과기정통부 2019</span></figcaption></figure>
          <figure class="aw-item"><span class="aw-logo"><img src="assets/awards/logo-jeju.png" alt="" onerror="this.style.display='none'"><i>JEJU</i></span><figcaption><b>제주특별자치도 표창</b><span>제주안심코드 2021</span></figcaption></figure>
        </div>
